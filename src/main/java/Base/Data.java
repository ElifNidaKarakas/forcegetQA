...
public class Data {
    public static String firstName = "Elif Nida ";
    public static String lastName = "Karakaş";
    public static String phone = "5388109345";
    public static String company = "Fireelance";
